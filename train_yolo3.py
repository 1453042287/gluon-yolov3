...
my_class = ['person', 'bike', 'bus', 'car', 'motor', 'rider', 'truck']
resume_map = {'person': 'person', 'bike': 'bicycle', 'bus': 'bus', 'car': 'car', 'motor': 'motorcycle', 'rider': 'person', 'truck': 'truck'}


def parse_args():
    parser = argparse.ArgumentParser(description='Train YOLO networks with random input shape.')
    parser.add_argument('--network', type=str, default='shufflenet_v2',
    ...
    parser.add_argument('--lr-decay-epoch', type=str, default='1,2',
...
if __name__ == '__main__':
    ...
    # net_name = 'yolo3_mobilenet1.0_custom'
    ...
    if args.syncbn and len(ctx) > 1:
        ...
        net.reset_class(my_class)
        async_net.reset_class(my_class)
    else:
        net = get_model(net_name, pretrained=False, classes=my_class)
        # net.reset_class(['person', 'bike', 'bus', 'car', 'motor', 'rider', 'truck'])
        async_net = net
